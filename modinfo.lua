...
meta =
{
    ...
    name = "AlwaysTellMeTheOdds",

    -- Title of your mod that will be displayed to players
    title = "Always Tell Me The Odds",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Creates a separate window alongside the research UI that shows you probability of each possible outcome",
